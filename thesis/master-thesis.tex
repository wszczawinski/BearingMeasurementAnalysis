...
\hypersetup{
  ...
  pdfkeywords={master thesis, mechanical engineering, data science, plain bearings, analyzes}
 }
...
\section{Automatic analyzes of similar datasets}
...
At this stage of the project there is already data as well as it has been cleaned and pre-processed and organized. One can take a deeper look at this data to get familiar with the properties and features. There is also an occasion to build a so-called intuition about the data set and begin to think about a strategy for creating the model. After a closer look at the data, there is an opportunity to raise a deeper discussion with experts in the field, try to find the first patterns and visualizations.
